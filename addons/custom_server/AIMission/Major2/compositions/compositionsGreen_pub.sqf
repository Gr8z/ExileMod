...
_default = [
	...
	[  // loot
		...
		["Land_CargoBox_V1_F",[-5,-5,0],blck_BoxesLoot_Major2,[0,0,0,10,10,3]]  	// No Weapons, Magazines, or optics; 10 each construction supplies and food/drink items, 3 backpacks
