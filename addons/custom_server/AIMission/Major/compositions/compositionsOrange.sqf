...
_default = [ //  Start, end message and map marker
	[  // mesasges
		"A group of Rogue Mafia was sighted in a nearby sector! Check the Orange marker on your map for the location!", // Mission Start message 1 for players
		"The Sector at the Orange Marker is under survivor control!",												// Mission End message for player
		"Rogue Mafia Patrol"																								// Map marker label
	],
	[  // Map objects
...
_default2 = [
	...
	[  // Select 2  Customized loot chests
		...
		["Box_NATO_Wps_F",[-5,-5,0],blck_BoxLoot_Major,[0,0,0,10,10,3]],  	// No Weapons, Magazines, or optics; 10 each construction supplies and food/drink items, 3 backpacks
...
[
	[
		"A Rogue Mafia resupply camp has been spotted. Check the Orange marker on your map for its location",
		"The resupply camp the Orange Marker is under player control",
		"Rogue Mafia Camp"
	],
	[
