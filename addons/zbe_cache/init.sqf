...
if (isServer) then {[_zbe_aiCacheDist,_zbe_minFrameRate,_zbe_cache_debug,_zbe_vehicleCacheDistCar,_zbe_vehicleCacheDistAir,_zbe_vehicleCacheDistBoat]execvm "\zbe_cache\zbe_cache\main.sqf"};