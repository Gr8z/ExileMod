...
try
{
        ...
        _traderPurchaseLog = format ["PLAYER: %1:%5 BOUGHT ITEM: %4 FOR %2 POPTABS | PLAYER TOTAL MONEY: %3",_playerObject,_salesPrice,_playerMoney,_itemClassName,(getPlayerUID _playerObject)];
    'ARMA_LOG' callExtension format['A3_EXILE_TRADERPURCHASELOG:%1',_traderPurchaseLog];       
