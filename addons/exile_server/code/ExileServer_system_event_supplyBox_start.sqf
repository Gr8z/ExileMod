...
["standardHintRequest", [format ["Admin Air Drop is marked on the map. ETA 10 minutes."]]] call ExileServer_system_network_send_broadcast;
_marker = createMarker [ format["ExileSupplyBox%1", diag_tickTime], _position];
_marker setMarkerText "Admin Air Drop";
_marker setMarkerType "mil_objective";
_marker setMarkerColor "ColorRed";
uiSleep (60 * 5);
["standardHintRequest", [format ["Admin Air Drop ETA 5 minutes."]]] call ExileServer_system_network_send_broadcast;
uiSleep (60 * 4);
["standardHintRequest", [format ["Admin Air Drop ETA 60 seconds."]]] call ExileServer_system_network_send_broadcast;
uiSleep (60 * 1);
