...
["toastRequest", ["InfoTitleAndText", ["Airdrop incoming!", "A Server Admin is going to drop an AirDrop in about ten minutes. Check your map for the location."]]] call ExileServer_system_network_send_broadcast;
_marker = createMarker [ format["ExileSupplyBox%1", diag_tickTime], _position];
_marker setMarkerType "ExileHeart";
uiSleep (60 * 5);
["toastRequest", ["InfoTitleAndText", ["Airdrop incoming!", "A Server Admin is going to drop a AirDrop in about five minutes."]]] call ExileServer_system_network_send_broadcast;
uiSleep (60 * 4);
["toastRequest", ["InfoTitleAndText", ["Airdrop incoming!", "A Server Admin is going to drop a AirDrop in a minute."]]] call ExileServer_system_network_send_broadcast;
uiSleep (60 * 1);
