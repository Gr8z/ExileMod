...
try
{
        ...
        _poptabLog = format ["POPTAB TRANSFER %1:%4 SENT %2 POPTABS TO %3:%5",_senderPlayerObject,_amountToTransfer,_receiverPlayerObject,(getPlayerUID _senderPlayerObject),(getPlayerUID _receiverPlayerObject)];    
        'ARMA_LOG' callExtension format['A3_EXILE_POPTABS:%1',_poptabLog];
}
catch
{
