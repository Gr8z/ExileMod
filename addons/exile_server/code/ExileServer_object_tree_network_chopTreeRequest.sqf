...
private["_sessionId","_parameters","_treeNetId","_tree","_treeHeight","_newDamage","_treePosition","_spawnRadius","_weaponHolders","_weaponHolder","_weaponHolderPosition"];
...
if (!isNull _tree) then
{
	if (alive _tree) then
	{
		...
		if ((count _weaponHolders) isEqualTo 0) then
		{
