...
try
{
    ...
    [_sessionID, "toastRequest", ["SuccessTitleAndText", ["Bounties", "You have successfully accepted a contract"]]] call ExileServer_system_network_send_to;
}
catch
{
    [_sessionID, "toastRequest", ["ErrorTitleAndText", ["Bounties", _exception]]] call ExileServer_system_network_send_to;
