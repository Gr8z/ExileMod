...
if!(_objVeh getVariable ["ExileIsPersistent", false])exitWith{[_requestFrom, "notificationRequest", ["Whoops", ["You can only store pincode protected vehicles into the garage!"]]] call ExileServer_system_network_send_to; false};
