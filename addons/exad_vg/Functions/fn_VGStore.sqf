...
if!(_objVeh getVariable ["ExileIsPersistent", false])exitWith{[_owner, "toastRequest", ["ErrorTitleAndText", ["Virtual Garage", "You can only store pincode protected vehicles in the garage!"]]] call ExileServer_system_network_send_to;false};
