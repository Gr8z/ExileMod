...
if(count _data > 0)then{
	...
	_text = format["%2 %1Pin code: %3 %1Fuel: %4 %1Damage: %5 %1Texture: %6 %1Items: %7 %1Magazines: %8 %1Weapons: %9", "<br/>", _displayName, _pinCode, _fuel, _damage, _texture, _items, _magazines, _weapons];
