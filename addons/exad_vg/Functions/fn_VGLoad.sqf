...
if(!_proceed)exitWith{[_owner, "toastRequest", ["ErrorTitleAndText", ["Virtual Garage", "The vehicle is not available anymore!"]]] call ExileServer_system_network_send_to};
