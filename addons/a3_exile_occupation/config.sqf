...
SC_fastNightsMultiplierDay  	= 6;                    	// the time multiplier to use during daylight hours (4 = 4x speed)
...
SC_staticBandits            	= [		//[[pos],ai count,radius,search buildings]	
                                    [[1104.83,7591.81,0],2,50,true],
                                    [[12104.8,2488.49,0],2,50,true],
                                    [[11487.8,6234.15,0],2,50,true],
                                    [[11670.7,4106.17,0],2,50,true],
                                    [[5529.99,12036.1,0],2,50,true],
                                    [[6517.22,12702.8,0],2,50,true],
                                    [[9599.57,6533.41,0],2,50,true],
                                    [[5698.51,11041.8,0],2,50,true],
                                    [[3934.62,13917.8,0],2,50,true],
                                    [[2634.01,11692.8,0],2,50,true],
                                    [[9470.39,3846.51,0],2,50,true],
                                    [[5580.87,4050.05,0],2,50,true],
                                    [[7128.64,7995.65,0],2,50,true],
                                    [[7446.36,8542.74,0],2,50,true],
                                    [[10768.2,8653.25,0],2,50,true],
                                    [[12026.0,9709.35,0],2,50,true],
                                    [[10031.2,11792.8,0],2,50,true],
                                    [[8593.64,10061.9,0],2,50,true]
								  ];     
...
if(SC_useApexClasses) then 
{
	...
	SC_BanditUniforms			= [	"U_IG_Guerilla1_1","U_IG_Guerilla2_1","U_IG_Guerilla2_2","U_IG_Guerilla2_3","U_IG_Guerilla3_1","U_BG_Guerilla2_1","U_IG_Guerilla3_2","U_BG_Guerrilla_6_1","U_BG_Guerilla1_1","U_BG_Guerilla2_2","U_BG_Guerilla2_3","U_BG_Guerilla3_1",
                                    "U_I_C_Soldier_Para_1_F","U_I_C_Soldier_Para_2_F","U_I_C_Soldier_Para_3_F","U_I_C_Soldier_Para_4_F","U_I_C_Soldier_Para_5_F","U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_2_F",
