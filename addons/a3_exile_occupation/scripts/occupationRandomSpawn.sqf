...
// Find a player to hunt
{
	...
	if(_suitablePlayer) then
	{
		...
		else
		{
			...
			{
				["toastRequest", ["InfoTitleAndText", ["Police Dispatch!", format["A Squad of Police AI just spawned near '%1' to take him out.",name  _selectedPlayer]]]] call ExileServer_system_network_send_broadcast;
			};
