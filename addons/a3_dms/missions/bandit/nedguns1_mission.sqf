/*
	Guns Guns Guns - reworked by [CiC]red_ned http://cic-gaming.co.uk
...
_vehicle = ["I_Truck_02_fuel_F",[(_pos select 0) -30, (_pos select 1) -30,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
...
_msgStart = ['#FFFF00',"Someone is out stealing guns, get in first!"];
