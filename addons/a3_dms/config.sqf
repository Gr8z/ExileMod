...
/* Mission System Settings */
	...
	DMS_TimeToFirstStaticMission		= [420,800];					// [Minimum,Maximum] time between first static mission spawn. | DEFAULT: 3-7 minutes.
...
/* AI Settings */
	...
	DMS_Bandit_Static_SpawnMoney		= 125;						// The amount of Poptabs carried by a bandit static gunner

	DMS_Bandit_Vehicle_MoneyGain		= 100;						// The amount of Poptabs gained for killing a bandit vehicle crew member
	DMS_Bandit_Vehicle_RepGain			= 150;						// The amount of Respect gained for killing a bandit vehicle crew member
	DMS_Bandit_Vehicle_RankGain			= 50;
	DMS_Bandit_Vehicle_SpawnMoney		= 150;						// The amount of Poptabs carried by a bandit vehicle crew member
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_skill_easy					= [["aimingAccuracy",0.20],["aimingShake",0.40],["aimingSpeed",0.40],["spotDistance",0.40],["spotTime",0.40],["courage",0.90],["reloadSpeed",0.90],["commanding",0.90],["general",0.40]];	// Easy
	...
	DMS_assault_weps =					[							// Assault Rifles
											...
											"Exile_Weapon_AK47",
											"Exile_Weapon_AKS_Gold", //NIARMS MARK HERE
											"hlc_rifle_ak12",
											"hlc_rifle_ak12GL",
											"hlc_rifle_aku12",
											"hlc_rifle_ak47",
	...
	DMS_MG_suppressor_chance			= 3;						// Percentage chance that an MG Class AI will get a suppressor
...
/* Loot Settings */
	...
	DMS_BoxWeapons =					[							// List of weapons that can spawn in a crate
											...
											"hlc_rifle_ak12", //MARKER FOR NIARMS
											"hlc_rifle_ak12GL",
											"hlc_rifle_aku12",
											"hlc_rifle_ak47",
											"hlc_rifle_ak74",
	...
	DMS_BoxOptics =						[							// List of optics that can spawn in a crate
											...
											// Nightstalker scope lost thermal in Exile v0.9.4
										];
