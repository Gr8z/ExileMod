...
DMS_MinDistFromWestBorder			= 1000;	// There's at least 2km of ocean from the west edge to the first bit of land.
...
DMS_MinDistFromNorthBorder			= 1000;	// There's around 5km of ocean from the north edge to the first bit of land (including the island).