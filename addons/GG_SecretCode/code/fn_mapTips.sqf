	...
	['',{
		...
		MAP_TIPS_JIP_T = [] spawn {
                tipsArray = [
					...
					'Call in an airdrop to save you a trip to the trader. These costs pop tabs and the loot in them is random.',
					...
					'You can store your vehicles in your virtual garage to protect them from griefers that would blow them up.'
