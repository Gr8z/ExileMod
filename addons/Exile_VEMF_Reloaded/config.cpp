...
class CfgVemfReloaded
{
	...
	class aiGear
	{
		...
		aiUniforms[] =
		{
			...
			"TRYK_U_B_PCUHs","TRYK_U_B_PCUGHs","TRYK_U_B_PCUODHs","TRYK_B_USMC_R","TRYK_B_USMC_R_ROLL",
			"TRYK_B_TRYK_UCP_T","TRYK_B_TRYK_3C_T","TRYK_B_TRYK_MTP_T","TRYK_B_TRYK_OCP_T","TRYK_B_TRYK_OCP_D_T","TRYK_DMARPAT_T",
