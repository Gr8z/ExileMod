...
chatCommandsP[] =
{
		...
		{"ad.min","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."},
		{"@dmin","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."},
		{"ad min","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."},
		{"a d m i n","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."},
		{"@d.min","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."},
		{"admiin","SUPPORT FORBIDDEN IN SIDECHAT! JOIN OUR TEAMSPEAK.."}
};
...
allowedIDDs[] =
{
	...
	24033,24030,24029,24028,24031,24034,22000,23000,
