...
_cantBuildNear = [
		        ...
		        "Land_Medevac_house_V1_F","Land_Medevac_HQ_V1_F","Land_HBarrierTower_F","Land_MilOffices_V1_F","Land_Dome_Big_F","Land_Dome_Small_F","Land_Research_house_V1_F","Land_Research_HQ_F"
                ];
_cantBuildDist = 200;
...
if( isClass(configFile >> "CfgMagazines" >> _itemClassName >> "Interactions" >> "Constructing") ) then
{
    ...
    try
    {
        ...
        {
        	["WHOOPS", ["You cannot build within 200m of blacklisted buildings!"]] call ExileClient_gui_notification_event_addNotification; 
        };
