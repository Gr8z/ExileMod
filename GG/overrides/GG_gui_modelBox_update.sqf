...
{
	clearBackpackCargoGlobal ExileClientModelBoxVehicle;
	clearItemCargoGlobal ExileClientModelBoxVehicle;
	clearMagazineCargoGlobal ExileClientModelBoxVehicle;
	clearWeaponCargoGlobal ExileClientModelBoxVehicle;
