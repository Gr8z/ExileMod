...
FNC_GET_ACTUAL_LOADOUT = {
	...
	switch (_this) do {
		...
		case 1:{
			...
			for "_i" from 1 to 3 do {player addItemToUniform "64Rnd_mas_9x18_mag";};
		...
		case 6:{
			...
			for "_i" from 1 to 4 do {player addItemToUniform "15Rnd_mas_9x21_Mag";};
			for "_i" from 1 to 4 do {player addItemToBackpack "20Rnd_mas_762x51_Stanag";};
			player addWeapon "srifle_mas_sr25_v";
			player addWeapon "hgun_mas_bhp_F";
			player addPrimaryWeaponItem "optic_mas_LRPS";
			player addPrimaryWeaponItem "bipod_02_F_hex";
			player addHeadgear "TRYK_r_cap_od_Glasses";
			player addHandgunItem "optic_mas_MRD";
			player addHandgunItem "muzzle_mas_snds_L";
		...
		case 7:{
			...
			for "_i" from 1 to 3 do {player addItemToVest "30Rnd_mas_556x45_Stanag";};
		...
		case 9:{
			...
			player addWeapon "Binocular";
			player addWeapon "arifle_mas_hk416_m203c_v";
			player addWeapon "hgun_mas_acp_F";
			player addPrimaryWeaponItem "muzzle_mas_snds_Mc";
			player addPrimaryWeaponItem "optic_mas_acog_rd_c";
			player addHandgunItem "optic_mas_MRD";
		...
		case 10:{
			...
			for "_i" from 1 to 3 do {this addItemToVest "30Rnd_mas_556x45_Stanag";};
			for "_i" from 1 to 4 do {player addItemToUniform "15Rnd_mas_9x21_Mag";};
