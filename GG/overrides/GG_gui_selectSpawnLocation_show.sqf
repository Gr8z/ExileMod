...
FNC_GET_ACTUAL_LOADOUT = {
	...
	switch (_this) do {
		...
		case 1:{
			...
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_18Rnd_9x19_Phantom";};
		...
		case 2:{
			...
			player addWeapon "Binocular";
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_18Rnd_9x19_Phantom";};
            for "_i" from 1 to 5 do {this addItemToVest "CUP_5x_22_LR_17_HMR_M";};
			player addItemToUniform "Exile_Magazine_Swing";
			player linkItem "ItemGPS";
		...
		case 3:{
			...
			player addWeapon "Binocular";
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_18Rnd_9x19_Phantom";};
			for "_i" from 1 to 4 do {this addItemToVest "CUP_20Rnd_762x51_DMR";};
			player addItemToUniform "Exile_Magazine_Swing";
			player linkItem "ItemGPS";
		...
		case 6:{
			...
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_15Rnd_9x19_M9";};
			for "_i" from 1 to 4 do {this addItemToVest "CUP_20Rnd_762x51_B_M110";};
			player addItemToUniform "Exile_Magazine_Swing";
			player addItemToVest "Exile_Item_InstaDoc";
			player addItemToVest "Exile_Item_PlasticBottleCoffee";
			player addItemToVest "Exile_Item_EMRE";
		...
		case 10:{
			...
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_17Rnd_9x19_glock17";};
			player addItemToUniform "Exile_Magazine_Swing";
			player addItemToBackpack "Exile_Item_Bandage";
			player addItemToBackpack "Exile_Item_MountainDupe";
		...
		case 11:{
			...
			for "_i" from 1 to 4 do {this addItemToUniform "CUP_30Rnd_9x19_MP5";};
			player addItemToUniform "Exile_Magazine_Swing";
		...
		case 15:{
			...
			player addHandgunItem "CUP_acc_CZ_M3X";
			player addItemToVest "CUP_HandGrenade_M67";
			for "_i" from 1 to 3 do {this addItemToVest "CUP_IlumFlareGreen_GP25_M";};
            for "_i" from 1 to 4 do {this addItemToVest "CUP_30Rnd_545x39_AK_M";};
            for "_i" from 1 to 4 do {this addItemToUniform "CUP_18Rnd_9x19_Phantom";};
			player addItemToUniform "Exile_Magazine_Swing";
			player addItemToVest "Exile_Item_InstaDoc";
