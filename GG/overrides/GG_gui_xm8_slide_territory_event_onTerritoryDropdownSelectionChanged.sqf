...
_timePayed = _flag getVariable ["ExileTerritoryLastPayed", _currentTimestamp];// calling last time territory was paid
...
_territoryPayDayInfo ctrlSetText (format ["Protection Money Last Paid: %1", _timePayed]);// displaying last time territory was paid
true