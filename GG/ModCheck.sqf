...
if(getText(configFile >> "cfgWeapons" >> "rhs_weap_m4a1" >> "displayname") isEqualTo "" || getText(configFile >> "cfgWeapons" >> "rhs_weap_svd" >> "displayname") isEqualTo "" || getText(configFile >> "cfgWeapons" >> "TRYK_H_headset2" >> "displayname") isEqualTo "" )then{
