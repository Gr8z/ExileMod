...
if(getText(configFile >> "cfgWeapons" >> "rhs_weap_M107" >> "displayname") isEqualTo "" || getText(configFile >> "cfgWeapons" >> "rhs_weap_svd" >> "displayname") isEqualTo "" || getText(configFile >> "cfgWeapons" >> "TRYK_H_headset2" >> "displayname") isEqualTo "" || getText(configFile >> "CfgVehicleClasses" >> "Ryanzombiesfast" >> "displayname") isEqualTo "" )then{
    _att = format["[WARNING %1!]",name player];
    _att hintC [
        parseText "<t shadow='2' size='3'align='center'color='#cf2e4e'>THIS SERVER IS RUNNING </t><br/><t shadow='2' size='1.75'align='center'color='#b0eb00'>@RHSUSAF @RHSAFRF @TRYK @Ryanzombies</t><br/><br/><t shadow='2'align='center' size='1.25'>These mods add new weapons, vehicles and Uniforms and zombies</t><br/><t shadow='2'align='center'>You will not be able to see or use the new items. It is recomended that you download:</t>",
        parseText "<t shadow='2'size='1.1' >Ryan's Zombies</t><br/><a shadow='2'size='0.8'align='center' href='http://www.armaholic.com/page.php?id=28958'>http://www.armaholic.com/page.php?id=28958</a>",
