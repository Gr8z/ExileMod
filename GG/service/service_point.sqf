...
_servicePointClasses = ["O_Truck_03_covered_F","Land_CarService_F","Land_fs_roof_F","Land_fs_feed_F","CargoNet_01_barrels_F","Exile_Trader_Vehicle","Land_A_FuelStation_Feed"]; // service point classes (can be house, vehicle and unit classes)
