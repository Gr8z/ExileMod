...
_RecipeTitle ctrlSetText "[GG] Recipes";
...
_RecipePic ctrlSetText "\exile_assets\texture\mod\icon.paa";
...
lbClear 5502;
lbClear 5501;
(_display displayCtrl 5507) ctrlSetText "\exile_assets\texture\mod\icon.paa";
