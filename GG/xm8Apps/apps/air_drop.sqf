...
_Box1Btn ctrlSetEventHandler ["ButtonClick", "boxCost = box1Cost;boxDonorCost = box1DonorCost;boxWepCount = box1WepCount;boxMagCount = box1MagCount;boxItemCount = box1ItemCount;"];
...
_Box2Btn ctrlSetEventHandler ["ButtonClick", "boxCost = box2Cost;boxDonorCost = box2DonorCost;boxWepCount = box2WepCount;boxMagCount = box2MagCount;boxItemCount = box2ItemCount;"];
...
_Box3Btn ctrlSetEventHandler ["ButtonClick", "boxCost = box3Cost;boxDonorCost = box3DonorCost;boxWepCount = box3WepCount;boxMagCount = box3MagCount;boxItemCount = box3ItemCount;"];
...
fnc_buyselected = {
  if (ExileClientPlayerMoney > boxCost) then {
    ...
    _crate addMagazineCargoGlobal [_mag, boxMagCount];
