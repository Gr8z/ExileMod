...
_drop2Info ctrlSetStructuredText (parseText (format ["<br/><t align='center'size='1.4'>%2</t><br/><t align='center'size='0.8'>Price = <img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='0.8' shadow='0' /> %1 Bank</t>",Vehicle2Cost,Vehicle2Name]));
...
_drop3Info ctrlSetStructuredText (parseText (format ["<br/><t align='center'size='1.4'>%2</t><br/><t align='center'size='0.8'>Price = <img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='0.8' shadow='0' /> %1 Bank</t>",Vehicle3Cost,Vehicle3Name]));
