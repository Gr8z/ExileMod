...
disableSerialization;
	...
	while {true} do 
	{
		...
		_time = (round(120-(serverTime)/60));  //edit the '240' value (60*4=240) to change the countdown timer if your server restarts are shorter or longer than 4 hour intervals
