...
if(PlayerHasPendingInv)then{
    ...
    _AcceptButton ctrlSetEventHandler ["ButtonClick", "[1]execVM 'GG\AdvancedBanking\Functions\AdvBanking_InviteHandleResponseXM8.sqf';"];
    ...
    _DeclineButton ctrlSetEventHandler ["ButtonClick", "[0]execVM 'GG\AdvancedBanking\Functions\AdvBanking_InviteHandleResponseXM8.sqf'"];
};
