...
class RscRewardPictureKeepAspect
{
	access = 0;
	colorBackground[] = {0,0,0,0};
	colorText[] = {1,1,1,1};
...
class RscExileRewardItemListBox: RscRewardListBox
{
...
class RscRewardShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
