...
[_display,_slide,([_slideClass,"componentsList"] call ExAd_fnc_getNextIDC),[0.4*_pW,4*_pH,15.2*_pW,7*_pH],"call GG_fnc_craftingApp_componentsLoad"] call ExAd_fnc_createList;
...
[_display,_slide,([_slideClass,"categoriesCombo"] call ExAd_fnc_getNextIDC),[0.4*_pW,2.5*_pH,15.2*_pW,1*_pH],"call GG_fnc_craftingApp_recipeLoad",""] call ExAd_fnc_createCombo;
