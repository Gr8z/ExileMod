...
ExAd_SB_ICON_BANK = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Bank.paa";		//STRING - Path to bank icon
ExAd_SB_ICON_CLAN = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Family.paa";	//STRING - Path to family icon
ExAd_SB_ICON_COMPASS = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Compass.paa";	//STRING - Path to compass icon
ExAd_SB_ICON_GRID = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Grid.paa";		//STRING - Path to grid icon
ExAd_SB_ICON_HP = 		"GG\ExAdClient\StatsBar\Icons\ExAd_Health.paa";	//STRING - Path to health icon
ExAd_SB_ICON_HUNGER = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Hunger.paa";	//STRING - Path to hunger icon
ExAd_SB_ICON_KD = 		"GG\ExAdClient\StatsBar\Icons\ExAd_KD.paa";		//STRING - Path to kill death ratio icon
ExAd_SB_ICON_PLAYERS = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Players.paa";	//STRING - Path to players icon
ExAd_SB_ICON_RESPECT = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Respect.paa";	//STRING - Path to respect icon
ExAd_SB_ICON_TEMP = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Temp.paa";		//STRING - Path to temperature icon
ExAd_SB_ICON_THIRST = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Thirst.paa";	//STRING - Path to thirst icon
ExAd_SB_ICON_TIMER = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Restart.paa";	//STRING - Path to restart icon
ExAd_SB_ICON_Wallet = 	"GG\ExAdClient\StatsBar\Icons\ExAd_Wallet.paa";	//STRING - Path to POP TABS icon
ExAd_SB_ICON_LOGO = 	"GG\images\logo.paa";		//STRING - Path to logo

ExAd_SB_COMPONENTS_COLORS = ["#000000", "#440B00","#FE1106","#CA7400","#A9C700","#11BF03"]; //STRINGS - Array of color codes, from bad to good. 

ExAd_SB_Timer = 2; 										//SCALAR - Restart time measured in hours. 

ExAd_SB_GUI_POS_Default = 	[-0.000156274 * safezoneW + safezoneX","0.973 * safezoneH + safezoneY","1.00031 * safezoneW","0.022 * safezoneH]; //ARRAY - Position with this attributes [x,y,w,h];
...
ExAd_SB_Show_Compass_Default = false;					//BOOLEAN - Template, show compass
...
ExAd_SB_Allow_Temp = 		false;						//BOOLEAN - Allow showing body temperature
