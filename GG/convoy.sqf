...
if (isServer) then {
	...
	donn_carsConvy = [
		//(0) Crew: 2 / Armed
		["I_G_Offroad_01_armed_F",0,["100Rnd_127x99_mag_Tracer_Yellow"]],
		//(1) Crew: 3 / Armed
		["I_G_Offroad_01_armed_F",1,["100Rnd_127x99_mag_Tracer_Yellow"]],
	...
	_loot1 = [
		...
		[["addMagazineCargoGlobal","Exile_Item_DuctTape",[2,3,4]]],
		[["addMagazineCargoGlobal","Exile_Item_ExtensionCord",[2,3,4]]],
		[["addMagazineCargoGlobal","Exile_Item_Surstromming",[4,5,6]]],
		[["addMagazineCargoGlobal","Exile_Item_MetalPole",[4,5,6]]],
		[["addMagazineCargoGlobal","Exile_Item_MetalBoard",[4,5,6]]],
		[["addMagazineCargoGlobal","Exile_Item_FuelCanisterEmpty",[2,3,4]]],
		[["addMagazineCargoGlobal","Exile_Item_Rope",[1,2,3]]],
		...
		[["addBackpackCargoGlobal","B_OutdoorPack_tan",[1,2,2]]]
	];
