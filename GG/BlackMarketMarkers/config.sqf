...
CC_blackMarketIntruderWarningMessage = "Enemy player just entered the area"; // Message that will be displayed when an enemy is in the area or enters the area.
