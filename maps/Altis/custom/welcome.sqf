...
// First
_title             = "Welcome To Exile";
_shorttext         = "Arma 3 Exile By [GG] Ghostz Gamerz";
_posText        = [0.8,0.5,0.4];


_title2         = "Website";
_shorttext2     = "www.GHOSTZGAMERZ.com";
_posText2        = [0.8,0.5,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "ts.GHOSTZGAMERZ.com";
...
_shorttext5     = "Welcome Messages <br />Custom Traders<br /> ";
